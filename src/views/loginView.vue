            ...
            <div class="flex items-center justify-center h-full">
                <div class="backdrop-blur bg-white/30 rounded-lg shadow-md px-8 py-10 max-w-md">
                    ...
                    <form @submit.prevent="onSubmit">
                        <h1 class="text-2xl text-white font-bold mb-6 text-center">Log In</h1>
                        <div class="mb-6">
                    ...
                    <div class="w-full text-center mt-6">
                        <span class="text-white font-semibold">I don't have an account yet!</span>
                        <span class="ml-1">
                            <router-link :to="{ name: 'SignUp', params: {} }"
                                class="text-primary text-orange-500 font-bold">Sign Up!</router-link>
                        </span>
                    </div>
                </div>
            </div>
